...
def result2(request):
	...
	userid = request.session['userid']
	print userid
	f=open('/home/unknown/Django_web/Django-1.8.5/learner2/datain2.csv','r+')
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	cursor=conn.execute("select id,name from pupil_user_info;")                                                                                                                            																	
	for row0 in cursor:	
		if row0[1]==userid:
	...
	ylabel('Performance scale')
	xlabel('Number of questions')
	fig4.savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig21.png')
	plt.clf()
	...
	plt.xlim(0, 4)
	plt.xticks(pos+width+0.1,labels)
	fig5 = savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig22.png')
	plt.clf() 
	...
	explode = (0.04,0.0)
	pie(fracs, explode=explode, labels=labels, colors=('g','w'), autopct='%1.0f%%', shadow=False ,radius=0.8)
	fig6.savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig23.png') 
	plt.clf()
...
def result3(request):
	...
	userid = request.session['userid']
	print userid
	f=open('/home/unknown/Django_web/Django-1.8.5/learner2/datain3.csv','r+')
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	cursor=conn.execute("select id,name from pupil_user_info;")                                                                                                                            																	
	for row0 in cursor:	
		if row0[1]==userid:
	...
	ylabel('Performance scale')
	xlabel('Number of questions')
	fig7.savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig31.png')
	plt.clf()
	...
	plt.xlim(0, 4)
	plt.xticks(pos+width+0.1,labels)
	fig8.savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig32.png')
	plt.clf() 
	...
	explode = (0.04,0.0)
	pie(fracs, explode=explode, labels=labels, colors=('g','w'), autopct='%1.0f%%', shadow=False ,radius=0.8)
	fig9.savefig('/home/unknown/Django_web/Django-1.8.5/learner2/static/img/fig33.png')
	plt.clf() 
