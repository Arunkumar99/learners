...
from pupil.models import User_info,Questions3,User_data,FeedBack,SessionData
...
def test10(request):
	...
	if (i<=10) :
		...
		return HttpResponseRedirect('/pupil/result31')
...
def test11(request):
	...
	if (i<=20) :
		...
		return HttpResponseRedirect('/pupil/result32')
...
def test12(request):
	...
	if (i<=num) :
		...
		return HttpResponseRedirect('/pupil/result33')
...
def result31(request):
	...
	cursor2=conn.execute("select rans from pupil_questions3 where set_id='1';")
	j=0
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status310')
	else:
		return HttpResponseRedirect('/pupil/status311')
...
def result32(request):
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status320')
	else:
		return HttpResponseRedirect('/pupil/status321')
...
def status310(request):
	...
	conn.commit();
	conn.close();
	return render_to_response('pupil/status310.html', context_dict, context)

def status311(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status311.html', context_dict, context)

def status320(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status320.html', context_dict, context)

def status321(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status321.html', context_dict, context)

def status330(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status330.html', context_dict, context)

def status331(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status331.html', context_dict, context)
