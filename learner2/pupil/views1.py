...
from pupil.models import User_info,Questions1,User_data,FeedBack,SessionData
...
def test4(request):
	...
	if (i<=10) :
		...
		return HttpResponseRedirect('/pupil/result11')
...
def test5(request):
	...
	if (i<=20) :
		...
		return HttpResponseRedirect('/pupil/result12')
...
def test6(request):
	...
	if (i<=num) :
		...
		return HttpResponseRedirect('/pupil/result13')
...
def result11(request):
	...
	cursor2=conn.execute("select rans from pupil_questions1 where set_id='1';")
	j=0
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status110')
	else:
		return HttpResponseRedirect('/pupil/status111')
...
def result12(request):
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status120')
	else:
		return HttpResponseRedirect('/pupil/status121')
...
def result13(request):
	...
	if result1[0]=='q':
		qualified = 1
		return HttpResponseRedirect('/pupil/status130')
	else:
		return HttpResponseRedirect('/pupil/status131')

def status110(request):
	context = RequestContext(request)
	...
	conn.commit();
	conn.close();
	return render_to_response('pupil/status110.html', context_dict, context)

def status111(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status111.html', context_dict, context)

def status120(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status120.html', context_dict, context)

def status121(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status121.html', context_dict, context)

def status130(request):
	context = RequestContext(request)
	context_dict = {'result': "Congradulations.You are qualified for the next level.",'qualified':qualified}
	conn = sqlite3.connect('/home/unknown/Django_web/Django-1.8.5/learner2/db.sqlite3')
	conn.execute("delete from pupil_user_data;")
	conn.commit();
	conn.close();
	return render_to_response('pupil/status130.html', context_dict, context)

def status131(request):
	context = RequestContext(request)
	context_dict = {'result': "Sorry.You are not qualified for the next level.",'qualified':qualified}
	return render_to_response('pupil/status131.html', context_dict, context)
